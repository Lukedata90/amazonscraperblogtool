...
export default function Sidebar({ activeCategory, onCategoryChange }: Props) {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          ...
          <span
            ...
            style={{ color: "#FF6600", fontSize: 13, letterSpacing: "0.12em" }}
          >
            AMAZON
          </span>
        </div>
        ...
        <span
          className="mt-2"
          style={{ color: "rgba(255,102,0,0.5)", fontSize: 9, letterSpacing: "0.15em" }}
        >
          INTELLIGENCE FEED
        </span>
      </div>
      ...
      <div className="hud-divider mx-4 my-2" />

      {/* System stats */}
      <div className="px-4 py-3">
        <SectionLabel>// Sistema</SectionLabel>
        <div className="flex flex-col gap-2 mt-2">
          <StatRow label="LAST SYNC" value="04:30 fa" />
          <StatRow label="ARTICOLI/GG" value="12" />
          <StatRow label="IN CODA" value="0" />
        </div>
      </div>
      ...
      <div className="px-4 py-3 flex-1">
        <SectionLabel>// Feed RSS</SectionLabel>
...
function StatRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between items-center">
      ...
      <span style={{ color: "#FF6600", fontSize: 9, fontWeight: 700 }}>{value}</span>
    </div>
  );
}
